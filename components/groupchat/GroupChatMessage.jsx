              ...
              <div className="px-3 py-2 flex flex-col gap-1.5">
                ...
                {!isOwn && msg.roomId && (
                  <button
                    ...
                    className="w-full font-mono text-xs text-primary-foreground bg-primary hover:bg-primary-dim rounded-sm py-1.5 mt-1 transition-colors duration-150 font-black"
                  >
                    Join Room →
                  </button>
                )}
