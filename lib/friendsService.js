...
import { checkSocialAchievements } from "@/lib/achievementService";
import { createNotification }       from "@/lib/notificationService";
import { ACHIEVEMENT_MAP }          from "@/lib/achievementService";
...
export async function acceptFriendRequest(requestId) {
  ...
  for (const uid of [req.fromUid, req.toUid]) {
    // count friends
    ...
    const friendCount = sentSnap.size + recvSnap.size;
    const newAch = await checkSocialAchievements(uid, {
      friendCount,
